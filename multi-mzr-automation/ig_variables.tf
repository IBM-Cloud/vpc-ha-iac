...
variable "web_image_region1" {
  ...
  type        = string
  validation {
    condition     = length(var.web_image_region1) == 41
    error_message = "Length of Custom image id for the web VSI from Region-1 should be 41 characters."
  }
}
...
variable "web_image_region2" {
  ...
  type        = string
  validation {
    condition     = length(var.web_image_region2) == 41
    error_message = "Length of Custom image id for the web VSI from Region-2 should be 41 characters."
  }
}
...
variable "app_image_region1" {
  ...
  type        = string
  validation {
    condition     = length(var.app_image_region1) == 41
    error_message = "Length of Custom image id for the app VSI from Region-1 should be 41 characters."
  }
}
...
variable "app_image_region2" {
  ...
  type        = string
  validation {
    condition     = length(var.app_image_region2) == 41
    error_message = "Length of Custom image id for the app VSI from Region-1 should be 41 characters."
  }
}
