...
variable "bastion_image_region1" {
  ...
  type        = string
  validation {
    condition     = length(var.bastion_image_region1) == 41
    error_message = "Length of Custom image id for the Bastion VSI Region-1 should be 41 characters."
  }
}
...
variable "bastion_image_region2" {
  ...
  type        = string
  validation {
    condition     = length(var.bastion_image_region2) == 41
    error_message = "Length of Custom image id for the Bastion VSI Region-2 should be 41 characters."
  }
}
...
* Desc: OS image to be used linux for Bastion server. This OS type should be same across both the regions.
* Type: string
**/
variable "bastion_os_type" {
  description = "OS image to be used linux for Bastion server. This OS type should be same across both the regions."
  type        = string
