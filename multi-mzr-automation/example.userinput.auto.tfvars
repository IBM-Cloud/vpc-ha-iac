...
#
# /** 
#     This is the list of public IP addresses of user's local machines. We will whitelist only these public IP in Bastion's security group. So that, Bastion server can 
...
#bandwidth = 3
#
###################################  Instance Group Input Variables  ##################################
#/**
