...
/**
* Name: vpn_routing_table_id
* Desc: This variable will hold the routing table id for vpn route
* Type: string
**/
variable "vpn_routing_table_id" {
  description = "This variable will hold the routing table id for vpn route"
  type        = string
}

/**
* Name: public_gateway_ids
* Desc: List of id of the public gateway where bastion subnet will get attached
* Type: list(any)
**/
variable "public_gateway_ids" {
  description = "List of id of the public gateway where bastion subnet will get attached"
  type        = list(any)
}
