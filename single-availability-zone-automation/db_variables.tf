...
locals {
  ...
  member_cpu_allocation_count = 3                     # total number of cpu cores allocated/shared to the dbaas service
  member_disk_allocation_mb   = 20480                 # total number of disk space in MB allocated/shared to the dbaas service
  member_memory_allocation_mb = 1024                  # total number of RAM in MB allocated/shared to the dbaas service
