/**
#################################################################################################################
*                       Load Balancer Output Variable Section for the Common Section
*                                 Start Here of the Common Section 
#################################################################################################################
**/
...
* Private IP address for the App Load Balancer
* This variable will return IP address for the App Load Balancer
**/
...
* Output Variable
* Element : LB DNS
* DNS address for the App and Web Load Balancer
